...
export function PositionsSection({ initialPositions }: PositionsSectionProps) {
  ...
  return (
    <section id="positions" className="w-full max-w-7xl mx-auto px-6 md:px-12 py-16 md:py-24">
      {/* Section Header */}
      <div className="flex items-center gap-3 mb-8">
        <span className="font-mono text-emerald-600 dark:text-emerald-400 text-lg font-bold">06.</span>
                ...
                >
                  ...
                  >
                    <div className="space-y-1">
                      ...
                      <div className="flex items-center gap-1 text-xs text-zinc-500 dark:text-zinc-400 pl-6">
                  ...
                  <AnimatePresence>
                    {isExpanded && (
                      <motion.div
                        ...
                        className="border-t border-black/10 dark:border-white/10 px-5 py-5"
                      >
