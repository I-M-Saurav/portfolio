  ...
  return (
    <section id="about" className="w-full max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-12 py-12 sm:py-16 md:py-20 lg:py-24">
      ...
      <div className="flex items-center gap-3 mb-6 sm:mb-8">
        <span className="font-mono text-emerald-600 dark:text-emerald-400 text-base sm:text-lg font-bold">01.</span>
      ...
      <div className="w-full rounded-xl border border-black/10 dark:border-white/10 bg-white/70 dark:bg-[#111116]/80 shadow-2xl backdrop-blur-md overflow-hidden">
        ...
        <div className="flex items-center justify-between px-4 sm:px-6 pt-3 border-b border-black/10 dark:border-white/10 bg-zinc-100/50 dark:bg-zinc-900/50">
          <div className="flex items-center gap-2">
            <button
              ...
              className={`flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-2 sm:py-2.5 text-xs font-mono rounded-t-lg transition-all border-t border-x min-h-[38px] sm:min-h-[36px] ${
                activeTab === "about.md"
        ...
        <div className="p-4 sm:p-6 md:p-8 lg:p-10 min-h-[360px]">
                ...
                <div className="flex flex-col sm:flex-row flex-wrap items-stretch sm:items-center gap-3 sm:gap-4 pt-1">
                  {profile.email && (
                    <button
                      ...
                      className="inline-flex items-center justify-center gap-2 min-h-[44px] px-4 py-2.5 rounded-lg border border-black/10 dark:border-white/10 bg-white/50 dark:bg-zinc-900/80 hover:bg-black/5 dark:hover:bg-white/10 font-mono text-xs text-zinc-800 dark:text-zinc-200 transition-all active:scale-[0.98] shadow-sm"
                    >
