  ...
  return (
    <section id="contact" className="w-full max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-12 py-12 sm:py-16 md:py-20 lg:py-24">
      ...
      <div className="w-full rounded-xl border border-black/10 dark:border-white/10 bg-white/70 dark:bg-[#111116]/80 shadow-2xl backdrop-blur-md overflow-hidden">
        ...
        <div className="flex items-center justify-between px-3 sm:px-4 py-2.5 sm:py-3 bg-zinc-200/70 dark:bg-zinc-900/90 border-b border-black/10 dark:border-white/10 font-mono text-xs text-zinc-500 dark:text-zinc-400">
          <div className="flex items-center gap-1.5 sm:gap-2">
            ...
            <div className="ml-2 sm:ml-3 flex items-center gap-1.5 text-zinc-600 dark:text-zinc-400">
              ...
              <span className="text-[11px] sm:text-xs">contact --info</span>
            </div>
          </div>
        ...
        <div className="p-4 sm:p-6 md:p-12 space-y-6 sm:space-y-8 max-w-3xl mx-auto text-center">
          {/* Prompt heading */}
          ...
          <div className="flex flex-col sm:flex-row flex-wrap items-center justify-center gap-3 sm:gap-4 pt-1 sm:pt-2">
            {profile.email && (
              <button
                type="button"
                onClick={handleCopyEmail}
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2.5 min-h-[44px] px-5 py-3 rounded-xl border border-black/10 dark:border-white/10 bg-white/60 dark:bg-zinc-900 hover:bg-black/5 dark:hover:bg-white/10 font-mono text-xs sm:text-sm text-zinc-900 dark:text-zinc-100 transition-all shadow-md active:scale-[0.98]"
              >
