...
export function EducationSection({ initialEducation }: EducationSectionProps) {
  ...
  return (
    <section id="education" className="w-full max-w-7xl mx-auto px-6 md:px-12 py-16 md:py-24">
      {/* Section Header */}
                  ...
                  <AnimatePresence>
                    {isExpanded && (
                      <motion.div
                        ...
                        className="border-t border-black/10 dark:border-white/10 px-5 py-5 space-y-3"
                      >
                        {edu.fieldOfStudy && (
                        ...
                        {edu.description && (
                          <p className="font-sans text-xs sm:text-sm text-zinc-700 dark:text-zinc-300 leading-relaxed pl-5.5 pt-1">
                            {edu.description}
                          </p>
                        )}
                      </motion.div>
