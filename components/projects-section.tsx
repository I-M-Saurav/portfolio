...
export function ProjectsSection({ initialProjects }: ProjectsSectionProps) {
  ...
  return (
    <section id="projects" className="w-full max-w-7xl mx-auto px-6 md:px-12 py-16 md:py-24">
      {/* Section Header */}
      <div className="flex items-center gap-3 mb-8">
        <span className="font-mono text-emerald-600 dark:text-emerald-400 text-lg font-bold">05.</span>
              ...
              return (
                ...
                >
                  ...
                  <button
                    ...
                    className="w-full p-5 text-left flex flex-col md:flex-row md:items-center justify-between gap-4 font-mono cursor-pointer select-none focus:outline-none focus-visible:ring-1 focus-visible:ring-emerald-500"
                  ...
                  >
                    <div className="space-y-2">
                      <div className="flex flex-wrap items-center gap-2.5">
                        ...
                        {project.featured && (
                          <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded text-[10px] font-mono font-bold bg-emerald-500/15 text-emerald-600 dark:text-emerald-400 border border-emerald-500/30 shadow-sm">
                      ...
                      {project.techStack && project.techStack.length > 0 && (
                        <div className="flex flex-wrap items-center gap-1.5 pt-0.5">
                          {project.techStack.map((tech, tIdx) => (
                            <span
                              key={tIdx}
                              className="px-2 py-0.5 rounded text-[11px] font-mono border border-black/10 dark:border-white/10 bg-white/50 dark:bg-zinc-900/60 text-zinc-600 dark:text-zinc-400"
                            >
                              {tech}
                            </span>
                          ))}
                  ...
                  <AnimatePresence>
                    {isExpanded && (
                      <motion.div
                        ...
                        className="border-t border-black/10 dark:border-white/10 px-5 py-5 space-y-5"
                      >
                        ...
                        <div className="flex flex-wrap items-center gap-3 pt-2">
                          {project.githubUrl && (
                            <a
                              ...
                              className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-zinc-900 dark:bg-zinc-100 hover:bg-zinc-800 dark:hover:bg-white text-white dark:text-zinc-900 font-mono text-xs font-semibold shadow-md transition-all active:scale-[0.98]"
                            >
                          ...
                          {project.liveUrl && project.liveUrl.trim() !== "" && (
                            <a
                              ...
                              target="_blank"
                              rel="noopener noreferrer"
                              className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-emerald-600 hover:bg-emerald-500 text-white font-mono text-xs font-semibold shadow-md shadow-emerald-600/20 transition-all active:scale-[0.98]"
                            >
